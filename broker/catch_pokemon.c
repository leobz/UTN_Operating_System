...
t_cola_proceso *cola_catch_pokemon_first=NULL;
t_cola_proceso *cola_catch_pokemon_last=NULL;
...
void encolar_proceso_catch_pokemon(int socket_cliente){
	...
	if(cola_catch_pokemon_first == NULL){
		cola_catch_pokemon_first = c;
	}
	else{
		cola_catch_pokemon_last->siguiente = c;
	}
	cola_catch_pokemon_last = c;
}
