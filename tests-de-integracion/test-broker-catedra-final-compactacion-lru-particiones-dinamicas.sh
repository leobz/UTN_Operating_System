...
echo "Ejecutando 'sh test-broker-catedra-final-compactacion-lru-particiones-dinamicas.sh'"
...
echo "\nEjecutando 'test-broker-catedra-final-compactacion-lru-particiones-dinamicas-2.sh'"
sh test-broker-catedra-final-compactacion-lru-particiones-dinamicas-2.sh


echo "\nEjecutando test:"
byexample -l shell broker-catedra-final-compactacion-lru-particiones-dinamicas.md
