...
Suscripción a GET_POKEMON

```  bash
$ ../gameboy/Debug/gameboy SUSCRIPCION GET_POKEMON 200 & # byexample: +timeout=4 +paste
...
```bash
$ sleep <sleep-time>; ../gameboy/Debug/gameboy BROKER GET_POKEMON Pikachu 6 6 10; sleep <sleep-time> # byexample: +timeout=20 +paste
Insertando mensaje GET
Extrayendo mensaje GET_POKEMON
Estoy por desencolar proceso GET_POKEMON
Empaquetando mensaje GET_POKEMON a enviar
```
...
```bash
$ cat broker.log
<...>[CONEXION] COD_OP:GET_POKEMON ID:10
<...>
```
